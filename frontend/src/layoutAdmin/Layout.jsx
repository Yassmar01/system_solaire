...
import {
    Avatar, Box, Chip, CircularProgress, ClickAwayListener, CssBaseline, Divider, Drawer, IconButton,
...
function Layout() {
    ...
    const menuItems = [
        ...
        { label: "Call Center", icon: <SupportAgent />, path: "/callcenter" },
        { label: "Facebook Leads", icon: <Facebook />, path: "/Facebookleads" },
        { label: "Clients & Calls", icon: <PhoneForwarded />, path: "/Clients_calls" },

        { label: "Technicians", icon: <Engineering />, path: "/Techniciens" },
        { label: "Accounts", icon: <PersonAdd />, path: "/AddAcounts" },
    ];
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <AppBar position="fixed" open={open} color="success">
                    <Toolbar>
                        ...
                        >
                            <MenuItem onClick={handleMenuClose} component={Link} to="/AddAcounts">
                                <ListItemIcon>
                            ...
                            <MenuItem onClick={handleMenuClose} component={Link} to="/dashboard">
                                <ListItemIcon>
                                    <DashboardRounded fontSize="small" color='error' />
                                </ListItemIcon>
                                Dashboard
                            </MenuItem>
