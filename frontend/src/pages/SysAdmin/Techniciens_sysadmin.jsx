            ...
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell>
                    <IconButton
                        ...
                        size="small"
                    >
                        <Link to={'/sysadmin/Techniciens/DetailsTech'} target="_blank"><RemoveRedEye color="success" /></Link>
...
export default Techniciens_sysadmin;
